cards_dict = {
    ...
    'Queen of Hearts': 10, 'King of Hearts': 10, 'Ace of Hearts': 11,  # Ace can also be 1 in some cases
    ...
    'Queen of Clubs': 10, 'King of Clubs': 10, 'Ace of Clubs': 11,
    ...
    'Queen of Spades': 10, 'King of Spades': 10, 'Ace of Spades': 11
}
# List of just the card names from the deck_of_cards dictionary
card_list = [
